              ...
              >
                <div
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(90deg, #132030 25%, #1e3a52 50%, #132030 75%)',
            ...
            >
              {Array.from({ length: columns }).map((_, colIndex) => (
                <td
                  ...
                  style={{
                    padding: 12,
                    textAlign: colIndex === 0 ? 'left' : colIndex < 3 ? 'left' : 'right'
                  }}
                >
                  <div
                    className="skeleton-shimmer"
                    style={{
                      ...
                      width: colIndex === 0 ? 60 : colIndex === 1 ? 140 : colIndex === 5 ? 80 : 60,
                      background: 'linear-gradient(90deg, #132030 25%, #1e3a52 50%, #132030 75%)',
                      backgroundSize: '200% 100%',
