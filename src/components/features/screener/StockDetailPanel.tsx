...
export function StockDetailPanel({
  ...
  return (
    <>
      ...
      {/* Mobile: Bottom Sheet */}
      <div
        className="md:hidden fixed bottom-0 left-0 right-0 max-h-[85vh]
    ...
    <div className="flex flex-col h-full w-full relative">
      ...
      <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          <h3 className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 mb-2">
            Metrics
          </h3>
          <MicroBar
        ...
        {(stock.topHolder || stock.ownerType) && (
          <div>
            <h3 className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant/70 mb-3">
              Top Holder
            </h3>
            <div className="bg-surface-container p-4 rounded-xl border border-outline-variant/30 flex justify-between items-center">
              <div>
                <p className="font-body text-xs text-on-surface-variant mb-1">
                  {stock.ownerType || "Unknown Type"}
                </p>
                <p className="font-body text-sm text-on-surface truncate max-w-[200px]">
                  {stock.topHolder || "Unknown Name"}
                </p>
              </div>
