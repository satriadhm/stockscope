...
import { AppHeader, KpiCards, MobileDrawer, TabBar } from "@/components/layout";
import {
  FlagsTab,
  HhiTab,
  OverviewTab,
...
import {
  ...
  usePlan,
  useStockData,
  useStockStatsExtended,
} from '@/hooks';

import type { DashboardFilters, Stock } from "@/types";
...
export function Dashboard(): React.ReactElement {
  ...
  const handleTierFilter = useCallback((tier: Stock["tier"] | null): void => {
  ...
  const handleStockSelect = useCallback((stock: Stock): void => {
