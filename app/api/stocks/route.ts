...
import { countStocks, fetchStocks } from "@/lib/services/stockService";

// import { authOptions } from '@/lib/auth/config';
// import { FREE_LIMIT } from '@/lib/auth/constants';
import type { PaginatedResponse, Stock, StockFilter } from "@/types";
...
function parseSortBy(raw: string | null): keyof Stock {
  ...
  return STOCK_SORT_KEYS.has(raw as keyof Stock)
    ? (raw as keyof Stock)
    : fallback;
}
